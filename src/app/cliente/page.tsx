        ...
        <div className="mb-10 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-2 text-[#666]">
              Escolha um serviço, selecione um horário e acompanhe seus agendamentos.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 rounded-2xl bg-white px-4 py-3 shadow-[0_10px_30px_rgba(0,0,0,0.06)]">
            ...
            <div>
              <p className="font-semibold text-[#1f1f1f]">Bibi Perigosa</p>
              <p className="text-sm text-[#777]">Cliente Premium</p>
            </div>
          </div>
        </div>
